        ...
        With frmDataEntry.lstViewForms
            ...
            Select Case frm
                ...
                Case "formSynoptic2RA1"
                    Try
                        With frmNewSynopticRA1.ucrSynopticRA1
                            If Not .chkRepeatEntry.Checked Then
                                Exit Sub
                            End If
                            stn = .ucrStationSelector.cboValues.SelectedValue
                            elm = .ActiveControl.Tag
                            yy = .ucrYearSelector.cboValues.Text
                            mm = .ucrMonthSelector.cboValues.Text
                            dd = .ucrDaySelector.cboValues.Text
                            hh = .ucrHourSelector.cboValues.Text
                            'MsgBox(stn & " " & elm & " " & yy & " " & mm & " " & dd & " " & hh)
                        End With
                        If Not objKeyPress.Entered_Value(stn, elm, yy, mm, dd, hh, obsv1) Then
                ...
                Case "form_daily2"
                    Try
                        ...
                        With frmNewFormDaily2.ucrFormDaily
                            If Not .chkRepeatEntry.Checked Then
                                Exit Sub
                            End If
                            stn = .ucrStationSelector.cboValues.SelectedValue
                            ...
                            dd = Mid(.ActiveControl.Name, 19, Len(.ActiveControl.Name) - 18)
                ...
                Case "form_hourly"
                    Try
                        With frmNewHourly.ucrHourly
                            ...
                            mm = .ucrMonthSelector.cboValues.Text
                            dd = .ucrDaySelector.cboValues.Text
                            hh = Strings.Mid(.ActiveControl.Name, 19, Len(.ActiveControl.Name) - 18)
                            'MsgBox(stn & " " & elm & " " & yy & " " & mm & " " & dd & " " & hh)
                        End With
