Public Class FrmConversionDewPointRh
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        Dim TT As Double, Tw As Double, Td As Double, RH As Double
        ...
        If Len(TT) > 0 And Len(Tw) > 0 Then
            ...
            If TT >= Tw Then
                If Not generate_dewpoint_and_rh(TT, Tw, Td, RH) Then Exit Sub
                dewpoint.Text = Td * 10
        ...
        End If
    End Sub
    Private Function generate_dewpoint_and_rh(TT As String, Tw As String, Td As String, RH As String) As Double
        On Error GoTo errhandler
        Dim Td_Fahrenheit As Double
        Dim Ed As Object
        Dim Tw_Fahrenheit As Double
        Dim Ew As Double
        Dim Ea As Double
        Dim Tp As Double
        Dim Tp_Fahrenheit As Double
        Dim Tp_Celcius As Double
        Dim svp1 As Double
        Dim svp2 As Double
        Dim Relative_Humidity As Double
        ...
        'dewpoint.Text = Tp_Celcius * 10
        'humidity.Text = svp1 / svp2 * 100
        dewpoint.Text = Math.Round(Tp_Celcius * 10, 1)
        humidity.Text = Math.Round(svp1 / svp2 * 100, 1)
