        ...
        Try
            ...
            If optV3Backup.Checked = True Then
                If Len(txtBkpFile.Text) = 0 Then
                    ...
                    Exit Sub
                End If
                sql_obsv = "use " & dbstr & "; SET foreign_key_checks = 0;LOAD DATA INFILE '" & bkpfile & "' " & ReplaceIgnore & " INTO TABLE observationinitial FIELDS TERMINATED BY ',' (recordedFrom,describedBy,obsDatetime,obsLevel,obsValue,flag,period,qcStatus);"
            Else
