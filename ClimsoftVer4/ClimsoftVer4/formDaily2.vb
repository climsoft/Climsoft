...
Public Class formDaily2
    ...
    Private Sub btnPush_Click(sender As Object, e As EventArgs) Handles btnPush.Click
        ...
        ''strBackupFileLocal = tableName & "_backup_" & frmLogin.txtUsername.Text & ".csv"
        ...
        ''strBackupFileLocal = strBackupFolderLocal & "\" & tableName & "_backup_" & frmLogin.txtUsername.Text & ".csv"
        ''backupFileLocalMapped = backupFolderLocalMapped & "\" & tableName & "_backup_" & frmLogin.txtUsername.Text & ".csv"
        ...
        ''strBackupFileRemote = tableName & "_backup_" & frmLogin.txtUsername.Text & ".csv"
        ...
        ''conn.ConnectionString = myConnectionString
        ''conn.Open()
        ''MsgBox("Connection remote successful!")
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If minuteNow = Val(txtTimerStartMinute.Text) And secondNow = 0 Then
            ...
            'compile_aws_data
            frmLogin.pushKeyEntryDataToRemote("form_daily2")
            lblDataPushMessage.Text = msgDataPushtoRemote
            lblDataPushMessage.Refresh()
        End If
    End Sub
