Public Class frmPlotter
    Private Sub frmPlotter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SQLElementString = "SELECT DISTINCT obselement.elementName 
                            FROM obselement,missing_stats 
                            WHERE obselement.elementId=missing_stats.Element"

        SQLDataString = "SELECT stationName, elementName, opening_record_date, closing_record_date, missing_amount 
                        FROM missing_stats,obselement,station 
                        WHERE missing_stats.Station=station.stationId
