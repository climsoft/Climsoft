Public Class frmUserManagement
    ...
    Private Sub btnAddNew_Click(sender As Object, e As EventArgs) Handles btnAddNew.Click
        ...
        connStr = frmLogin.txtusrpwd.Text ' & ";AllowLoadLocalInfile=true"
    ...
    Sub CurrentDB(connstr As String, ByRef dbnme As String)
        ...
        portstr = Strings.Mid(connstr, Edb + 6, 4)
        svrstr = Strings.Mid(connstr, Ssvr, Esvr - Ssvr)
        dbnme = Strings.Mid(connstr, Sdb, Edb - Sdb)
